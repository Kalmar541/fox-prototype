...
{
    /*
     * Управляет движением игрока, сменой анимации.
     * Жизни игрока отнимают взрывы бомб, падение за пределы экрана завершают игру.
     * Игрок прыжками отталкивает падающие бомбы в BOSSа. упавшие на землю может сталкивать за сцену.
     * 
     */
